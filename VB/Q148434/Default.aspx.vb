...
Namespace Q148434
	Partial Public Class _Default
		...
		Private Function Convert(ByVal source As IPivotDataSource) As DataTable
			Dim result As New DataTable()
			Dim properties As PropertyDescriptorCollection = (CType(source, ITypedList)).GetItemProperties(Nothing)
